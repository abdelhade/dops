...
<div class="glass-card operation-show-screen no-print" style="max-width: 900px; margin: 0 auto;">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem 2rem;">
        ...
        <div>
            ...
            <div style="font-weight: 600; margin-top: 0.25rem;">{{ $operation->operationType?->name ?? $dash }}</div>
        </div>
        <div>
    ...
    <div class="operation-print-body">
        <div class="operation-print-grid">
            ...
            <div class="operation-print-field">
                ...
                <span class="operation-print-value">{{ $operation->operationType?->name ?? $dash }}</span>
            </div>
            <div class="operation-print-field">
            ...
            @if($isGeneral)
            <div class="operation-print-field">
                <span class="operation-print-label">{{ __('dobs.operation_kind') }}</span>
                <span class="operation-print-value">{{ $operation->operationKind?->name ?? $dash }}</span>
            </div>
            @endif
            <div class="operation-print-field">
                <span class="operation-print-label">{{ $isGeneral ? __('dobs.operation_silk_final_product') : __('dobs.operation_product_1') }}</span>
            ...
            <div class="operation-print-field">
                <span class="operation-print-label">{{ $isGeneral ? __('dobs.operation_silk_supplier') : __('dobs.operation_printing_press') }}</span>
