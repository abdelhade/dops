...
@section('title', __('dobs.create_category'))

@section('header_title', __('dobs.create_category'))
@section('header_subtitle', __('dobs.create_category_subtitle'))
...
<div class="glass-card" style="max-width: 600px; margin: 0 auto;">
    <form action="{{ route('categories.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('dobs.category_name_placeholder') }}" value="{{ old('name') }}" required>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fa-solid fa-save"></i> {{ __('dobs.save_category') }}
            </button>
        </div>
    </form>
</div>
