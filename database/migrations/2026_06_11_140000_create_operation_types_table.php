...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $types = [
            ...
            ['name' => 'SILK-SCREEN', 'slug' => 'silk_screen', 'form_mode' => OperationTypeMode::SilkScreen->value, 'serial_prefix' => 'SS', 'sort_order' => 2, 'is_system' => true],
            ['name' => 'عام', 'slug' => 'general', 'form_mode' => OperationTypeMode::General->value, 'serial_prefix' => 'GEN', 'sort_order' => 3, 'is_system' => true],
        ];
